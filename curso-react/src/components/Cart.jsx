                ...
                <div className="col-md-10 offset-1">
                    ...
                    <div>
                        <table className="table table-borderless">
                            <thead>
                                <tr>
                                    <td colSpan={4} scope="row" className="text-end" onClick={clear}>
                            ...
                            <tbody className="align-middle">
                                {cart.map(item => (
                                    <tr key={item.id} className="contenedor-carrito">
                                        ...
                                        <td scope="row" className="nombre-carrito text-start ">{item.nombre} <br /> <b>${item.precio}.000</b></td>
                                        <td scope="row" className="text-center cantidad-carrito">{item.cantidad} <br /> <Link className="eliminar-carrito" onClick={() => { removeItem(item.id) }}>Eliminar</Link></td>
